      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-slate-900 mb-4 tracking-tight">Our Practice Areas</h2>
            <div className="w-16 h-1 bg-slate-900 mx-auto"></div>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {/* Service 1 */}
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100 flex flex-col h-full transition-all duration-300 hover:shadow-xl">
              <div className="h-56 overflow-hidden relative">
                ...
                <div className="absolute bottom-6 left-6 flex items-center text-white">
                  ...
                  <h3 className="text-xl font-bold">Landlord & Tenant Board</h3>
                </div>
              </div>
              <div className="p-8 flex-grow flex flex-col">
                ...
                <ul className="space-y-3 mb-10 flex-grow">
                  {[
                    ...
                    <li key={i} className="flex items-center text-sm text-slate-700">
                      <CheckCircle2 className="h-4 w-4 text-slate-900 mr-3 flex-shrink-0" />
                      <span>{item}</span>
                    </li>
                  ))}
                </ul>
                <button 
                  ...
                  className="w-full border border-slate-200 text-slate-900 py-3.5 rounded-xl font-medium transition-all hover:bg-slate-50 flex items-center justify-center"
                >
                  Learn More
                </button>
              </div>
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100 flex flex-col h-full transition-all duration-300 hover:shadow-xl">
              <div className="h-56 overflow-hidden relative">
                ...
                <div className="absolute bottom-6 left-6 flex items-center text-white">
                  ...
                  <h3 className="text-xl font-bold">Small Claims Court Matters</h3>
                </div>
              </div>
              <div className="p-8 flex-grow flex flex-col">
                <p className="text-slate-500 mb-8 text-sm leading-relaxed">
            ...
            <div className="bg-white rounded-2xl overflow-hidden shadow-sm border border-slate-100 flex flex-col h-full transition-all duration-300 hover:shadow-xl">
              <div className="h-56 overflow-hidden relative">
                ...
                <div className="absolute bottom-6 left-6 flex items-center text-white">
                  ...
                  <h3 className="text-xl font-bold">Notary Services</h3>
                </div>
              </div>
              <div className="p-8 flex-grow flex flex-col">
                <p className="text-slate-500 mb-8 text-sm leading-relaxed">
